...
const decorateOrder = (order, tokens) => {
  ...
  // Note: VIBS should be considered token0, mETH is considered token1
  // Example: Giving mETH in exchange for VIBS
  if (order.tokenGive === tokens[1].address) {
    token0Amount = order.amountGive; // The amount of VIBS we are giving
    token1Amount = order.amountGet; // The amount of mETH we want...
  } else {
    token0Amount = order.amountGet; // The amount of VIBS we want
